...
if ($selectStmt)
{
    $selectStmt->bind_param("s", $_SESSION['unameG2']);
...
<html> 
    ...
    <div class="navbar">
    <div class="display">
            <img src="https://asset.brandfetch.io/id3BHBKuok/idIoOmPqzs.png" height=30px width=30px>
            <p class="">Screening Project 2</p>
        </div>
        <h1><?php $_SESSION['unameG2'] ?></h1>
        <nav>
            <ul>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="userdetails">
        <form action="#" class="row g-3 needs-validation" id="update_form" method="post" enctype="multipart/form-data" novalidate>
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip02" name="email" value="<?php echo $_SESSION['unameG2']; ?>" disabled readonly>
      </div>
      <div class="col-md-4 position-relative">
...
$(document).ready(function() {
  ...
  //$('#update').click(function() {
    ...
    $.ajax({
      type: 'POST',
      url: 'server.php', // Replace with the actual URL
      data: {
        dob: dob,
        country: country,
        state: state,
    ...
    <div class="circleContainer">
        <img id="userDisp" src= "<?php echo $Icon ?>" class="circle-image">
    </div>
</div>
  ...
  <div class="col-md-3 position-relative">
    ...
    <div class="mb-3">
        ...
        <div class="footer">
          <div class"copyright">
            <center><p>© 2023 Copyright: Guvi Screening Project 2</p></center>
            </div>
            <div class="social">
                <nav>
                    <ul>
